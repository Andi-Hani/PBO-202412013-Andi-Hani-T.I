...
# =================================================================
# MAIN PROGRAM (JAWABAN TUGAS a–g)
# =================================================================
if __name__ == "__main__":
    uni = Universitas("Universitas A")

    # Tambah 2 program studi baru
    ...
    # Tambahkan minimal 2 mata kuliah setiap prodi
    # TI
    ...
    # MI
    prodi_mi.tambah_matakuliah(MataKuliah("MI301", "Administrasi Jaringan"))
    prodi_mi.tambah_matakuliah(MataKuliah("MI302", "Keamanan Informasi"))
    ...
    m3.tambah_nilai(Nilai("MI301", 80))
    m3.tambah_nilai(Nilai("MI302", 75))

    semua_mahasiswa = [m1, m2, m3]

    # Tampilkan daftar mata kuliah setiap program studi
